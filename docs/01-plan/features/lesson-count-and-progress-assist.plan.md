...
- **상태: 구현 완료 · 미출시** (2026-08-20) — Step 1~6 전부 반영.
  설계서 `docs/02-design/features/lesson-count-and-progress-assist.design.md` · ADR-057 참조.
  `/docs` 사용자 가이드는 **출시 시점에** 올린다(앱에 없는 기능을 안내하면 거짓말이 된다).
