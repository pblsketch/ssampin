...
status: Draft (Phase 1+2+3 main 머지 PR #30 · Phase 5 1차 main 머지 PR #35 · Phase 4 구현·검증 완료 — 브랜치 feat/mobile-swipe-quickrec)
---
...
| 4     | F-10 스와이프-투-리빌 · F-11 햅틱 · F-12 코치마크                          | ✅ 구현·검증 완료 (담임 명단 한정) — 브랜치 feat/mobile-swipe-quickrec (수업 명단 스와이프는 후속)        | §5 상세 |
