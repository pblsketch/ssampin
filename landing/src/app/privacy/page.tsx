        ...
        <>
          ...
          <ul>
            ...
            <li>
              ...
              웹, Docs 등)에서 보이지 않습니다. <strong>학생 사진을 넣으신 경우</strong>, 백업을 켜
              두면 <strong>학생 얼굴 사진도 같은 폴더에 함께 백업</strong>됩니다(휴대폰에서도 쓰기
              위한 것입니다). 백업을 켜지 않으면 사진은 선생님 컴퓨터를 벗어나지 않습니다. 설정 →
              백업/복원의 <em>학생 사진</em>에서 지우면 컴퓨터와 이 폴더에서 함께 삭제됩니다.
            </li>
            <li>
