...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '심의 대상인지는 학교가 판단하실 사항이라 저희가 단정해 드리지 않습니다. 쌤핀은 학생 계정을 만들지 않고 학생에게서 직접 정보를 받지도 않지만, 선생님이 과제 수합·전자 서명 같은 협업 기능을 쓰시면 학생 이름이 클라우드에 저장됩니다. 심의가 필요하다고 보시는 학교를 위해 심의자료와 개인정보 관련 서식을 준비해 두었으니 pblsketch@gmail.com으로 요청해 주세요.',
      },
    },
  ],
};
