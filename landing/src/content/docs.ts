  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: '얼굴 보고 이름 외우기',
        body: [
          '자리배치 화면의 이름 학습 버튼을 누르면 자유, 순서, 맞혀보기, 이름 쓰기 네 가지 방식으로 학생 이름을 익힐 수 있습니다.',
          '나이스에서 사진 명렬표를 내려받아 학급 명렬 관리의 사진 명렬표 버튼으로 넣으면 학생 얼굴 사진이 함께 등록되어, 자리 위치가 아니라 얼굴을 보고 이름을 떠올리는 연습을 할 수 있습니다. 최신 한글 파일과 엑셀 파일을 지원하며, 예전 방식으로 저장된 파일은 나이스에서 다시 내려받아 주세요.',
          '이름 쓰기는 사진을 보고 이름을 직접 입력하면 앱이 채점합니다. 초성 보기로 힌트를 얻거나 모르겠어요로 넘길 수 있고, 한 바퀴가 끝나면 틀린 학생만 다시 풀 수 있습니다.',
          '얼굴 학습은 컴퓨터에서만 사용할 수 있습니다. 휴대폰에서는 사진 없이 이름 학습만 지원합니다.',
          '사진은 선생님 컴퓨터에 저장되고, 드라이브 백업을 켜 두면 드라이브의 쌤핀 동기화 폴더에도 함께 보관됩니다. 이 폴더는 드라이브에서 보이는 일반 폴더입니다. 설정의 백업/복원에서 저장된 사진 수를 확인하고 언제든 모두 지울 수 있습니다. 학생에게 보이는 화면과 바탕화면 위젯에는 사진이 표시되지 않습니다.',
        ],
      },
    ],
    ...
    sections: [
      {
        ...
        title: '지원 기준 버전',
        body: [
          '이 가이드는 쌤핀 v2.4.1에서 사용할 수 있는 기능을 기준으로 정리했습니다. 버전별 상세 변경 내역은 앱의 설정 > 앱 정보에서 확인하실 수 있습니다.',
        ],
      },
      {
        id: 'recent',
