    ...
    sections: [
      ...
      },
      {
        ...
        callout: {
          ...
          body: '부서 자료는 관리자 선생님의 개인 Google Drive(보통 15GB)에 쌓입니다. 멤버 선생님들이 올린 파일도 마찬가지입니다. Drive가 가득 차면 자료실이 멈추는 것은 물론이고 그 선생님의 Gmail 수신과 쌤핀 동기화까지 함께 멈추므로, 자료실 화면에 늘 보이는 사용량을 살펴봐 주세요. 80%가 되면 알려 드립니다.',
        },
      },
      {
        id: 'spaces',
