    ...
    sections: [
      {
        ...
        bullets: [
          '출결이 아닌 기록은 큰 분류 하나를 고르고, 세부 내용을 태그로 여러 개 붙이는 방식입니다. 입력칸에 원하는 단어를 적고 Enter를 누르면 나만의 분류·태그를 바로 만들어 다음에도 이어 쓸 수 있습니다.',
          '상단의 태그 관리에서 태그를 추가·이름변경·삭제할 수 있고, 이름변경·삭제는 이미 작성한 기록에도 자동으로 반영됩니다(기본 제공 태그는 삭제되지 않습니다).',
          '통계 모드에서 결석·지각·칭찬·상담 같은 숫자 칸을 누르면, 화면을 옮기지 않고 그 자리에서 해당 기록의 날짜·사유·교시·메모를 모아 볼 수 있습니다.',
          '조회 모드는 담임 기록과 수업(교과) 기록이 같은 방식으로 보이며, 학생별 타임라인·결과 요약·바로 수정·엑셀 내보내기를 지원합니다.',
        ],
      },
      {
        id: 'record-draft',
