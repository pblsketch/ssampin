    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          '일정 탭에서 마감일이 있는 할 일도 함께 보입니다. 날짜 칸에는 속이 빈 작은 동그라미로 표시되고(일정은 꽉 찬 점), 아래 목록의 [할 일] 칸에서 동그라미를 누르면 그 자리에서 완료됩니다. 마감이 지난 할 일은 빨갛게 맨 위에 옵니다. 마감일을 옮기거나 내용을 고치는 것은 할 일 화면에서 합니다. 컴퓨터 쌤핀에서 이 표시를 끄면 휴대폰에서도 함께 꺼집니다.',
