  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          'v2.3.9부터 Windows에서는 제목 표시줄을 두지 않습니다. 유리 효과와 바탕화면 비치기를 켜면 Windows가 창 전체에 유리를 입히는데, 제목 표시줄만 따로 불투명하게 남길 방법이 없어 표시줄 자체를 없앴습니다. 대신 최소화·최대화·닫기 버튼은 오른쪽 위에 그대로 있습니다.',
    ...
    sections: [
      {
        ...
        title: '지원 기준 버전',
        body: [
          '이 가이드는 쌤핀 v2.3.9에서 사용할 수 있는 기능을 기준으로 정리했습니다. 버전별 상세 변경 내역은 앱의 설정 > 앱 정보에서 확인하실 수 있습니다.',
        ],
      },
      {
        id: 'recent',
        title: '최근 반영된 주요 기능',
        bullets: [
          '유리 효과 — 카드를 반투명하게 하고 뒤를 흐리게, 바탕화면까지 비치게 (v2.3.9, 설정 > 화면)',
          'Windows에서 제목 표시줄이 사라지고 창 위쪽 빈 곳을 잡아 옮기는 방식으로 바뀜 (v2.3.9)',
          '어두운 테마에서 "오늘" 카드 색을 테마에 맞게 조정 (v2.3.9)',
