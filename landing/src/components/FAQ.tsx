...
const faqs = [
  ...
  },
  {
    ...
    answer:
      '네, macOS도 지원해요! 위의 다운로드 버튼에서 macOS용을 받으세요. Apple Silicon(M1~M4)과 Intel Mac 모두 지원합니다. 처음 실행 시 "개발자를 확인할 수 없음" 경고가 뜨면, 시스템 설정 → 개인정보 보호 및 보안에서 "확인 없이 열기"를 클릭하세요.',
  },
  {
  ...
  },
  {
    ...
    answer:
      '현재 구글 보안 심사가 진행 중이라 신규 사용자의 구글 연동이 일시적으로 제한되고 있어요. 심사가 완료되면 정상적으로 사용할 수 있습니다. 시간표, 좌석배치, 메모 등 핵심 기능은 구글 연동 없이도 모두 정상 동작하니 안심하고 사용해주세요! 심사 완료 시 앱 업데이트로 안내드릴게요.',
  },
  {
