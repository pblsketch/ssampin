...
const faqs: { question: string; answer: ReactNode }[] = [
  ...
  },
  {
    ...
    answer:
      'macOS는 현재 베타로 지원해요. Apple Silicon(M1~M4)과 Intel Mac 모두 같은 파일 하나로 설치되니 칩을 확인하실 필요 없어요. Apple 인증서가 없어 처음 실행 시 보안 경고가 뜨는데, 경고 창에서 "완료"를 누른 뒤 시스템 설정 → 개인정보 보호 및 보안에서 "그래도 열기"를 클릭하면 실행됩니다. 자세한 방법은 위의 설치 안내 섹션을 확인해주세요.',
  },
  {
