      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <FadeIn>
          <div className="flex items-center gap-3">
            <span className="rounded-full bg-sp-accent/10 px-3 py-1 text-xs font-semibold text-sp-accent">
              NEW
            </span>
          </div>
          <h2 className="mt-3 text-3xl font-bold text-sp-text md:text-4xl">모바일에서도 쌤핀</h2>
          <p className="mt-3 text-base text-sp-muted">교무실 PC의 데이터를 교실에서도 확인하세요</p>
        </FadeIn>
              ...
              <div>
                ...
                <div className="mt-4 grid grid-cols-1 gap-3">
                  {features.map((f) => (
                    <div
                      key={f.title}
                      className="flex items-center gap-3 rounded-lg border border-sp-border/60 bg-sp-surface/60 px-4 py-3"
                    >
                ...
                {/* Google Drive 동기화 */}
                <div className="mt-6 rounded-xl border border-sp-accent/30 bg-sp-accent/5 p-4">
                ...
                {isMobile ? (
                  ...
                  <div className="flex flex-col items-center gap-4 text-center">
                    ...
                    <div className="w-full space-y-2.5">
                      <p className="mb-3 text-xs font-semibold uppercase tracking-wider text-sp-accent">
                        이렇게 시작하세요
                      </p>
                      <div className="flex items-start gap-3 rounded-lg border border-sp-border/60 bg-sp-surface/60 px-4 py-3 text-left">
                        <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-sp-accent/15 text-xs font-bold text-sp-accent">
                          1
                        </span>
                        <div>
                    ...
                    <a
                      href={MOBILE_URL}
                      className="mt-2 inline-flex items-center gap-2 rounded-xl bg-sp-accent px-8 py-4 text-lg font-bold text-white shadow-lg shadow-sp-accent/25 transition-all hover:-translate-y-0.5 hover:bg-sp-accent-hover hover:shadow-sp-accent/35"
                    >
                      <span>📱</span>
                      모바일 앱 설치하기
                    </a>
                  ...
                  /* PC 방문자: QR코드 */
                  <div className="flex flex-col items-center gap-4 text-center">
                    <div className="rounded-2xl border border-sp-border bg-white p-4">
                      <QRCodeSVG
                        value={MOBILE_URL}
                        size={180}
                        level="M"
                    ...
                    <p className="rounded-lg border border-sp-border bg-sp-surface px-4 py-2 font-mono text-xs text-sp-muted">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-3">
            {installSteps.map((s, i) => (
              <FadeIn key={s.step} delay={0.25 + i * 0.1}>
                <div className="rounded-xl border border-sp-border bg-sp-card p-5 text-center shadow-sm">
                  <div className="mx-auto flex h-8 w-8 items-center justify-center rounded-full bg-sp-accent/15 text-sm font-bold text-sp-accent">
                    {s.step}
                  </div>
