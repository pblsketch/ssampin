...
import { validateImage, getImageFromClipboard } from '../../utils/imageUtils';
    ...
    >
      ...
      <div className="flex items-end gap-2">
        ...
        <button
          ...
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-sp-accent text-white transition-colors hover:bg-sp-accent-hover disabled:opacity-40 disabled:cursor-not-allowed"
          aria-label="전송"
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M22 2 11 13" />
