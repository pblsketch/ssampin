...
### 📚 수업 관리
- 수업반(수업 클래스) 생성 및 관리
- 수업반별 명렬표(학년/반 소속 지원), 좌석배치, 진도 관리, 출결 관리
...
- Google Drive 동기화: 데이터를 Google Drive에 백업하고 복원 가능
...
4. 업데이트 실패 시: ssampin.vercel.app에서 최신 설치 파일을 수동 다운로드하라고 안내합니다.
...
- 업데이트 실패 → ssampin.vercel.app에서 최신 버전 수동 다운로드
