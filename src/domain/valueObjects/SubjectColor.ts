...
export interface SubjectColorPreset {
  ...
  readonly tw: {
    ...
    readonly text: string;       // 'text-yellow-300' (다크 모드)
    readonly textLight: string;  // 'text-yellow-200' (위젯 다크용)
    readonly textOnLight: string; // 'text-yellow-700' (라이트 모드용)
...
export const COLOR_PRESETS: readonly SubjectColorPreset[] = [
  ...
  {
    id: 'blue', label: '파란색',
    tw: { bg: 'bg-blue-500/20', border: 'border-blue-500/30', text: 'text-blue-300', textLight: 'text-blue-200', textOnLight: 'text-blue-700', bgSolid: 'bg-blue-400' },
    argb: 'FF93C5FD',
  },
  {
    id: 'purple', label: '보라색',
    tw: { bg: 'bg-purple-500/20', border: 'border-purple-500/30', text: 'text-purple-300', textLight: 'text-purple-200', textOnLight: 'text-purple-700', bgSolid: 'bg-purple-400' },
    argb: 'FFC4B5FD',
  },
  {
    id: 'orange', label: '주황색',
  ...
  {
    id: 'indigo', label: '인디고',
    tw: { bg: 'bg-indigo-500/20', border: 'border-indigo-500/30', text: 'text-indigo-300', textLight: 'text-indigo-200', textOnLight: 'text-indigo-700', bgSolid: 'bg-indigo-400' },
    argb: 'FFA5B4FC',
  },
  {
    id: 'teal', label: '청록색',
  ...
  },
  {
    ...
    tw: { bg: 'bg-violet-500/20', border: 'border-violet-500/30', text: 'text-violet-300', textLight: 'text-violet-200', textOnLight: 'text-violet-700', bgSolid: 'bg-violet-400' },
    argb: 'FFC4B5FD',
  },
  {
    id: 'amber', label: '앰버',
  ...
  {
    id: 'slate', label: '회색',
    tw: { bg: 'bg-slate-500/20', border: 'border-slate-500/30', text: 'text-slate-300', textLight: 'text-slate-200', textOnLight: 'text-slate-700', bgSolid: 'bg-slate-400' },
    argb: 'FF94A3B8',
  },
];
