  ...
  return (
    ...
    >
      {onTrackAuthor && (
        ...
        >
          <span className="material-symbols-outlined text-base text-sky-400">person_search</span>이
          작성자의 다른 카드 보기
        </button>
      )}
      {onUpdateNickname && (
      ...
      {onBulkHideStudent && (
        ...
        >
          <span className="material-symbols-outlined text-base">visibility_off</span>이 학생 카드
          모두 숨김
        </button>
      )}
    </div>
