      ...
      <div className="rounded-xl bg-amber-500/15 border border-amber-500/40 p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 text-sm leading-relaxed">
            <p className="font-semibold text-amber-50 mb-1">학교 Google 계정은 차단될 수 있어요</p>
            <p className="text-amber-100 mb-2">
              학교에서 발급한 계정(@*.go.kr, @*.sen.go.kr 등)은 관리자 정책으로 외부 앱 접근이 차단되는 경우가 많아요.
              연결은 되지만 캘린더·드라이브 호출이 모두 <span className="font-mono text-xs text-amber-50">401 (UNAUTHENTICATED)</span> 오류로 실패합니다.
            </p>
            <p className="text-amber-100">
              <span className="font-semibold text-amber-50">개인 Gmail 계정으로 연결하시는 걸 권장</span>해요. 이미 학교 계정으로 연결한 상태에서 동기화 오류가 뜬다면, 아래에서 연결을 해제하고 개인 Gmail로 다시 연결해주세요.
            </p>
          </div>
        </div>
      </div>
