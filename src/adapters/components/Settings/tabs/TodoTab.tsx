  ...
  return (
    <>
      <SettingsSection
        ...
        actions={<span className="text-caption font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-yellow-500/15 text-yellow-500 ring-1 ring-yellow-500/20">Beta</span>}
      >
