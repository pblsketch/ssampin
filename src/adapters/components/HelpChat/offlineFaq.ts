...
export const OFFLINE_FAQ: readonly FaqItem[] = [
  ...
  },
  {
    ...
    answer: '네! 시간표 편집 모드에서 왼쪽의 교시 시간 영역을 클릭하면 시작·종료 시간을 인라인으로 바로 수정할 수 있어요. 설정 페이지에 갈 필요 없이 시간표 화면에서 바로 교시 시간을 조정할 수 있어요.',
  ...
  },
  {
    ...
    answer: '인터넷 연결을 먼저 확인해주세요. 구글 계정 로그인이 만료됐을 수 있으니 설정 → Google Drive에서 연결 해제 후 다시 연결해보세요. 학교 컴퓨터에서만 안 되는 경우, 보안 프로그램이 차단하고 있을 수 있어요. "Google 계정 연결" 클릭 후 30초 기다리면 "다른 방법으로 로그인" 안내가 나타나요. 이 방법으로 진행하면 해결돼요! (v1.8.2 이상)',
    keywords: ['구글', 'Google', 'Drive', '드라이브', '동기화', '백업', '연동', '모바일', '휴대폰', '학교', '연결 중', '안 움직여', '멈춰'],
    category: 'troubleshoot',
  },
  {
    question: '학교 컴퓨터에서 구글 연결이 안 돼요',
    answer: '학교 보안 프로그램(V3, 알약 등)이 구글 로그인을 차단하는 경우예요. "Google 계정 연결" 버튼 클릭 후 30초 정도 기다려 주세요. "다른 방법으로 로그인하기" 안내가 자동으로 나타나요. 안내에 따라 브라우저에서 코드를 복사·붙여넣기 하면 연결이 완료돼요. 이 방법은 v1.8.2 이상에서 지원됩니다.',
    keywords: ['학교', '컴퓨터', '구글', '연결', '안 돼', '멈춤', '연결 중', 'V3', '알약', '방화벽', '차단', 'PKCE'],
    category: 'troubleshoot',
  },
  {
  ...
  {
    keywords: ['할 일 순서', '할일 순서', '순서 변경', '순서 조절', '할일 정렬', '드래그', '할일 위치'],
    question: '할일 순서를 변경하려면?',
    answer: '할일 목록에서 항목을 길게 누르거나 드래그하면 순서를 자유롭게 변경할 수 있어요!\n\n또한 상단의 정렬 버튼으로 "우선순위 순"과 "D-Day 순" 전환도 가능해요.\n\n💡 수동으로 정한 순서는 저장되어 다음에 열어도 유지됩니다.',
    category: 'general',
  },
  {
  ...
  },
  {
    ...
    answer: '네! v1.8.0부터 입력 모드가 학생목록 / 입력폼 / 참조패널 3컬럼으로 개편됐어요. 오른쪽 참조 패널에서 "오늘" 탭(선택 학생의 오늘 기록)과 "이력" 탭(과거 기록)을 보면서 새 기록을 입력할 수 있어요. 컬럼 너비는 드래그로 조절 가능해요.',
    keywords: ['담임메모', '3컬럼', '레이아웃', '참조', '이력', '입력', '컬럼', '패널'],
    category: 'homeroom',
  },
  {
    question: '담임메모 진행현황 대시보드는 뭔가요?',
    answer: '학급 전체 기록 현황을 한눈에 보여주는 대시보드예요.\n\n• 기록 없는 학생 수, 학생당 평균 기록 건수\n• 나이스 미반영 출결 학생별 드릴다운\n• 상담방법별 분석 (대면, 전화, 온라인 등)\n• 후속조치 기한 관리 (지연/다가오는 건)\n• 주의 학생 알림 카드 (무기록, 출결만, 후속미이행)',
    keywords: ['담임메모', '진행현황', '대시보드', '통계', '나이스', '미반영', '후속조치', '분석'],
    category: 'homeroom',
  },
  {
    question: '담임메모 검색에서 날짜를 직접 지정할 수 있나요?',
    answer: '네! 검색 탭의 기간 필터에서 "직접 지정" 옵션을 선택하면 시작일~종료일을 원하는 대로 설정할 수 있어요. 액션 대시보드에서 나이스 미반영이나 후속조치 건수를 클릭하면 바로 해당 조건으로 필터링도 돼요.',
    keywords: ['담임메모', '검색', '날짜', '필터', '기간', '직접 지정', '커스텀', '액션'],
    category: 'homeroom',
  },
  {
    question: '담임메모에서 이전 기록을 바로 수정할 수 있나요?',
    answer: '네! 입력 모드의 오른쪽 참조 패널 "이력" 탭에서 과거 기록을 펼치면 인라인 편집 버튼이 나타나요. 모달 없이 바로 내용을 수정할 수 있어요.',
