...
export const OFFLINE_FAQ: readonly FaqItem[] = [
  ...
  {
    question: '결번 학생은 어떻게 표시되나요?',
    answer: '결번(전학·퇴학 등) 학생은 번호와 "결번" 라벨이 흐리게 표시되어 선택할 수 없는 상태로 보여요. 상담예약이나 담임메모에서 결번 학생이 실수로 선택되는 일이 없도록 처리됩니다.',
    keywords: ['결번', '전학', '퇴학', '빈 번호', '학생 삭제'],
    category: 'class-management',
  },
];
