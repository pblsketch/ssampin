...
export const OFFLINE_FAQ: readonly FaqItem[] = [
  ...
  },
  {
    ...
    answer: '설정(⚙️) → 시간표 설정에서 NEIS 자동 연동을 선택하세요. 학교명을 검색하고 학년/반을 선택하면 자동으로 시간표가 채워집니다. 직접 입력도 가능해요.\n\n💡 참고: NEIS 자동 연동은 학급 시간표만 가능해요. 교사 개인 시간표는 NEIS 공개 API에서 제공되지 않아 직접 입력이 필요합니다.',
    keywords: ['시간표', '연동', 'NEIS', '나이스', '설정'],
    category: 'timetable',
  },
  {
    question: '교사 시간표도 NEIS에서 자동으로 가져올 수 있나요?',
    answer: 'NEIS 자동 연동은 학급 시간표만 가능해요. 교사 개인 시간표는 개인정보에 해당하여 NEIS 공개 API에 제공되지 않습니다. 교사 시간표는 시간표 페이지에서 "교사" 탭을 선택한 뒤 직접 입력해주세요. 한 번 입력하면 저장되고, Google Drive 동기화를 켜두면 다른 기기에서도 유지돼요.',
    keywords: ['교사 시간표', '교사시간표', '내 시간표', '개인 시간표', '교사 시간표 연동', '교사 시간표 NEIS', '교사 시간표 자동', '교사 시간표 안 나와'],
    category: 'timetable',
  },
  {
    question: '시간표를 입력했는데 위젯에 안 나와요',
    answer: '대시보드와 위젯의 시간표에는 "학급"과 "교사" 두 개 탭이 있어요. 입력한 시간표 종류와 보고 있는 탭이 다를 수 있습니다.\n\n• 학급 시간표를 입력하셨다면 → 위젯에서 "학급" 탭을 선택해주세요.\n• 교사 시간표를 입력하셨다면 → 위젯에서 "교사" 탭을 선택해주세요.\n\n위젯 기본 탭은 "교사"로 설정되어 있어서, 학급 시간표만 입력한 경우 빈 화면으로 보일 수 있어요.',
    keywords: ['시간표 위젯', '위젯 시간표', '시간표 안 뜨', '시간표 안뜨', '입력했는데 안', '위젯에 안 나와', '시간표 안 보여', '주간시간표 위젯'],
    category: 'timetable',
  },
  {
  ...
  },
  {
    ...
    answer: '설정(⚙️) → 좌석 → "좌석 관계 설정"에서 조건을 설정할 수 있어요.\n\n설정할 수 있는 조건:\n• **분리**: 특정 학생 둘을 떨어뜨려 앉히기 (최소 거리 설정)\n• **인접**: 특정 학생 둘을 가까이 앉히기 (최대 거리 설정)\n• **영역 고정**: 특정 학생을 맨앞/맨뒤/왼쪽/오른쪽 등 지정 영역에 배치\n• **고정 좌석**: 특정 학생을 정확한 좌석에 고정\n\n조건을 설정해두면 "랜덤 배치" 시 자동으로 반영돼요!',
    keywords: ['조건', '제약', '구역', '분리', '인접', '고정', '랜덤', '좌석 관계', '떨어뜨려', '가까이', '안 붙게', '분리 조건', '좌석 조건', '자리 조건', '앞자리'],
    category: 'seating',
  },
  {
  ...
  },
  {
    ...
    answer: '설정 → 디스플레이 → 글꼴에서 11가지 한글 폰트 중 선택하거나, 직접 다운로드한 폰트 파일(.woff2, .ttf, .otf)을 업로드하여 사용할 수 있어요. 눈누(noonnu.cc) 같은 무료 폰트 사이트에서 좋아하는 폰트를 다운받아 적용해보세요!',
    keywords: ['폰트', '글꼴', '글씨', '글자', '변경', '바꾸기', '바꿀', '업로드', '커스텀', '내 폰트'],
    category: 'settings',
  },
  {
  ...
  {
    question: '위젯 스타일을 꾸밀 수 있나요?',
    answer: '네! 위젯 편집 패널 또는 설정 → 디스플레이 탭에서 테마 프리셋, 투명도, 테두리, 배경 패턴, 강조 색상 등을 자유롭게 변경할 수 있어요.',
    keywords: ['위젯', '스타일', '꾸미기', '커스터마이징', '투명도', '테두리', '배경', '패턴', '강조', '색상'],
    category: 'settings',
  },
  {
    question: '노션 테마가 있나요?',
    answer: '네! v1.6.0에서 노션 라이트/다크, 크래프트 노트 라이트/다크 총 4종의 새 테마 프리셋이 추가됐어요. 설정 → 디스플레이에서 선택할 수 있어요.',
    keywords: ['노션', '테마', '크래프트', '프리셋', '라이트', '다크'],
    category: 'settings',
  },
  {
    question: '모둠(그룹) 좌석 배치는 어떻게 하나요?',
    answer: '좌석배치 페이지에서 모둠 레이아웃 모드를 선택하면 학생들을 모둠별로 묶어 배치할 수 있어요. 위젯에서도 모둠 모드가 반영돼요.',
    keywords: ['모둠', '그룹', '좌석', '배치', '조별'],
    category: 'seating',
  },
  {
    question: '학생 생일을 일정에 자동으로 넣을 수 있나요?',
    answer: '네! 학생 명단에 생년월일을 입력한 후, 일정 관리에서 생일 동기화 토글을 켜면 학생 생일이 캘린더에 자동 등록돼요.',
    keywords: ['생일', '생년월일', '동기화', '학생', '캘린더', '일정'],
    category: 'schedule',
  },
  {
    question: '급식 메뉴를 직접 입력할 수 있나요?',
    answer: '네! NEIS에 급식 정보가 없을 때 급식 페이지에서 수기로 메뉴를 입력하거나, CSV 파일로 한 번에 불러올 수 있어요.',
    keywords: ['급식', '수기', '입력', 'CSV', '메뉴', '직접'],
    category: 'general',
  },
  {
    question: '할 일을 마감일 순으로 볼 수 있나요?',
    answer: '네! 할 일 목록에서 D-Day 순 정렬을 선택하면 마감일이 가까운 순서대로 플랫 리스트로 보여줘요.',
    keywords: ['할일', '마감', 'D-Day', '정렬', '디데이', '순서'],
    category: 'general',
  },
  {
    question: '오늘의 한마디 색상을 바꿀 수 있나요?',
    answer: '네! 오늘의 한마디 편집 화면에서 배경, 텍스트, 강조 색상을 요소별로 자유롭게 변경할 수 있어요.',
    keywords: ['오늘의 한마디', '한마디', '색상', '배너', '메시지', '커스텀'],
    category: 'general',
  },
  {
    question: '시간표 페이지에서 바로 NEIS를 불러올 수 있나요?',
    answer: '네! v1.6.0부터 시간표 페이지에서 편집 모드 없이 바로 NEIS 불러오기 버튼으로 시간표를 가져올 수 있어요.',
    keywords: ['시간표', 'NEIS', '나이스', '불러오기', '바로', '편집'],
    category: 'timetable',
  },
  {
    question: '유치원/학원이 학교 검색에서 안 나와요',
    answer: '유치원·학원·대안학교 등은 NEIS에 등록되어 있지 않아 검색되지 않아요. "직접 입력" 버튼을 눌러 학교명을 수동으로 입력하시면 됩니다. NEIS 연동(시간표·급식·학사일정 자동 가져오기)은 사용할 수 없지만, 직접 입력으로 쌤핀의 다른 기능은 모두 정상 사용 가능해요!',
    keywords: ['유치원', '학원', '대안학교', 'NEIS', '나이스', '검색', '안 나와', '안나와', '안뜨', '검색결과', '못 찾'],
    category: 'troubleshoot',
  },
  {
  ...
  {
    question: '교사 시간표를 엑셀로 업로드할 수 있나요?',
    answer: '네! 시간표 페이지에서 "교사" 탭 → 엑셀 업로드 버튼을 클릭하면 컴시간 양식의 엑셀 파일을 자동 감지하여 시간표를 한 번에 입력할 수 있어요. 엑셀 다운로드도 가능합니다.',
    keywords: ['교사 시간표', '엑셀', '업로드', '다운로드', '컴시간', '시간표 가져오기', '시간표 내보내기', '교사시간표 엑셀'],
    category: 'timetable',
  },
  {
    question: '담임메모에서 자리 배치로 학생을 선택할 수 있나요?',
    answer: '네! 담임메모(학생 기록) 입력 화면에서 학생 선택 영역 상단의 "번호 순" / "자리 배치" 토글 버튼을 사용하면, 실제 좌석 배치도를 보면서 학생을 선택할 수 있어요.',
    keywords: ['담임메모', '자리배치', '좌석', '학생 선택', '번호순', '자리 배치 뷰', '좌석도', '학생기록'],
    category: 'homeroom',
  },
  {
    question: '테마를 변경할 수 있나요?',
    answer: 'v1.6.4부터 기본 테마가 밝은 Notion 스타일 라이트 테마로 변경되었어요. 설정에서 테마 프리셋(다크/라이트)을 선택하거나, 위젯 스타일(카드 모서리, 간격, 배경색, 글꼴 등)을 세밀하게 커스터마이징할 수 있습니다.',
    keywords: ['테마', '라이트', '다크', 'Notion', '노션', '밝은', '어두운', '배경', '스타일', '커스터마이징', '프리셋'],
    category: 'settings',
  },
  {
    question: '명렬표 NEIS 양식으로 가져올 수 있나요?',
    answer: 'v1.6.4에서 명렬표 양식이 NEIS 호환으로 통합되었어요. 가져오기 시 미리보기 모달에서 데이터를 확인한 후 반영할 수 있습니다. 학년·반 컬럼도 자동으로 인식됩니다.',
    keywords: ['명렬표', 'NEIS', '나이스', '호환', '가져오기', '양식', '미리보기', '학생 명단'],
    category: 'class-management',
  },
  {
    question: '자퇴/전출한 학생은 어떻게 처리하나요?',
    answer: '담임 업무 > 명렬 관리에서 해당 학생의 상태를 변경할 수 있어요.\n\n• 상태 종류: 재학, 전출, 휴학, 제적, 자퇴, 퇴학, 기타\n• 상태 변경 시 사유 메모 입력 가능\n• 비활성 상태 학생은 좌석배치, 출결, 명렬표에서 자동으로 비활성화(흐리게 표시)돼요.\n• 데이터는 삭제되지 않고 보존되며, 필요시 "재학"으로 다시 변경할 수 있어요.',
    keywords: ['결번', '전학', '퇴학', '자퇴', '휴학', '제적', '빈 번호', '학생 삭제', '학생 빠진', '학생 나간', '상태'],
    category: 'class-management',
  },
];
