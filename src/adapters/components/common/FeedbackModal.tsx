            ...
            >
              ...
              <ul className="space-y-1.5 text-xs text-sp-muted mb-4 flex-1">
                <li className="flex items-center gap-1.5">
                  <span className="text-sp-accent text-[8px]">●</span> 사용법 질문
                </li>
                <li className="flex items-center gap-1.5">
                  <span className="text-sp-accent text-[8px]">●</span> 버그 신고 &amp; 기능 제안
                </li>
                <li className="flex items-center gap-1.5">
                  <span className="text-sp-accent text-[8px]">●</span> 즉시 답변
                </li>
              </ul>
