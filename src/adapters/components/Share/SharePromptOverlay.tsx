 ...
 *
 * Phase 3 (2026-05-21): 자체 backdrop/wrapper 제거 → 공용 Modal 베이스로 통합.
 * ModalCoordinator 큐에 SHARE_PROMPT priority로 등록 (가장 후순위).
 */
export function SharePromptOverlay() {
  ...
  // Phase 3: ModalCoordinator 큐 등록 (SHARE_PROMPT priority — 가장 후순위)
  ...
  return (
    <Modal
      isOpen
      onClose={handleDismissLater}
      title="공유 권유"
      srOnlyTitle
      size="sm"
      panelClassName="!w-[min(384px,calc(100vw-32px))] rounded-2xl shadow-2xl ring-0"
    >
      <div className="px-6 py-8 flex flex-col items-center text-center">
        <span className="text-4xl mb-4">💌</span>
        <h3 className="text-lg font-bold text-sp-text mb-2">쌤핀이 도움이 되고 있나요?</h3>
        <p className="text-sm text-sp-muted mb-6">동료 선생님께도 추천해주세요!</p>
