...
- [ADR-095 · 상담·설문 교사 명단 조회는 Google 신원으로 연다 — 소유자는 만들 때 서버가 박고, 옛 열쇠 경로는 기한으로 닫는다 (2026-09-09, 승인·실행 대기)](docs/03-decisions/ADR-095.md)
- [ADR-096 · 학생 자기평가서는 과제 수합 위에 올린다 — 거울 카드로 받고, 교사가 고른 것만 근거가 된다 (2026-09-08)](docs/03-decisions/ADR-096.md)
- [ADR-097 · 학생 번호는 배열 위치가 아니라 명렬표의 실제 출석번호다 — 제출물 연결도 소속을 먼저 본다 (2026-09-08)](docs/03-decisions/ADR-097.md)

- [ADR-098 · 쌤도구를 별도 창으로 띄운다 — 상태는 "멈추고 담아 넘기고", 소유자는 언제나 한 창 (2026-09-09)](docs/03-decisions/ADR-098.md)

- [ADR-099 · 작성 방식은 선생님이 고른다 — 공통 규정과 작성 구성을 가르고, 순서는 요청서가 정한다 (2026-09-09, 서버 적용 승인 대기)](docs/03-decisions/ADR-099.md)

- [ADR-100 · 학급 목록에 수업 요일·교시를 보여준다 — 근거는 주 단위로 하나만, 자리는 행 전체 폭 (2026-09-09, 구현 완료·미출시)](docs/03-decisions/ADR-100.md)

- [ADR-101 · 상담 주제는 선생님이 미리 차려 둔다 — 고른 결과는 새 칸이 아니라 잠긴 메모 안으로 (2026-09-09, 구현 완료·073 운영 적용·앱 미출시)](docs/03-decisions/ADR-101.md)
