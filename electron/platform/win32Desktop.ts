 ...
 *
 * 참고: SchoolBoard(`@school-board/desktop` v1.1.5) `desktopWidget.js` 패턴.
 ...
 * 64-bit pointer 로 변환 시 koffi 의 `intptr` 와 호환 안 되는 경우가 있어 SchoolBoard 도
 * 동일한 방식을 사용한다.
 */
 ...
 *
 * SchoolBoard 와 동일한 트릭이지만 본 함수는 독립 구현.
 */
