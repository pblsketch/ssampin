 ...
 *
 * 채널:
 *  - `oneclick-portal:status` : 설치·실행 여부와 업무 바로 열기 지원 여부 조회
 *  - `oneclick-portal:launch` : 실행. 업무를 지정하면 그 화면까지 연다.
 *      업무 없이 부르면 이미 떠 있을 때 다시 켜지 않는다.
 *      업무를 지정하면 이미 떠 있어도 부른다 — 저쪽이 떠 있는 창에 요청을 넘기고 끝낸다.
 *
